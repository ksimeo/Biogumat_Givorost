...
<head>
    ...
    <script type="text/javascript" src="../script/changepassw.js"></script>
</head>
<style>
...
<form name="form" action="changepassw.do" method="POST">
    <div id="passwordplank">
        <table>
            ...
            <tr class="fieldsName">
                <td>
                    <h4>Старий пароль: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        <input type="password" name="oldpassw" size="10" required/>
                    </h4>
                </td>
            </tr>
            <tr class="fieldsName">
