/**
 * @author Ksimeo on 08.04.2015.
 * @version 2.5
 * @since 1.0
 */


//TODO Доработать так чтобы сравнение паролей не отображалось, если хотя бы одно из полей не заполнено.
...
function CancelCreateUsr() {

    document.location = "/users.ado";
}